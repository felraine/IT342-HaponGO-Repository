...
public class UserLessonController {
    ...
    public ResponseEntity<UserLesson> assignFirstLessonToUser(@PathVariable int userId) {
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<List<UserLesson>> getUserLessons(@PathVariable int userId) {
    ...
    public ResponseEntity<UserLesson> getActiveLessonForUser(@PathVariable int userId) {
    ...
    public ResponseEntity<UserLesson> markLessonAsCompleted(@PathVariable int userId, @PathVariable int lessonId) {
    ...
    public ResponseEntity<UserLesson> moveToNextLesson(@PathVariable int userId) {
