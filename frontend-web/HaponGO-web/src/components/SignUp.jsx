        ...
        <div className="lg:pl-20 flex flex-col items-center lg:items-start">
          ...
          <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-[400px] text-left mt-4 mb-10">
            <form className="space-y-3">
              ...
              <input type="text" className="w-full h-8 p-2 border border-gray-300 rounded-md text-lg" />
              <label className="block">Email</label>
              <input type="text" className="w-full h-8 p-2 border border-gray-300 rounded-md text-lg" />
              <label className="block">Password</label>
              <input type="password" className="w-full h-8 p-2 border border-gray-300 rounded-md text-lg" />
